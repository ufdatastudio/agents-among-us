...
Replaces the nltk.corpus.stopwords dependency with a static set so that
no download step is required at runtime.
"""
...
ENGLISH_STOP_WORDS = frozenset({
    ...
    "isn't", "it", "it'd", "it'll", "it's", "its", "itself", "just", "ll",
    ...
    "she", "she'd", "she'll", "she's", "should", "should've", "shouldn",
